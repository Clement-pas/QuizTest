const categories = {
    ...
    [
        { question: "Quelle est la personne qui se fait mal avec le moniteur de ski Popeye ?", answer: "Mme Schmitt" },
        { question: "Qu’est-ce que la personne blessée a selon Jérôme ?", answer: "La jambe luxée" },
        ...
        { question: "Qu’ont-ils oublié, les anciens propriétaires de la chambre 205 ?", answer: "Leur Scrabble" },
        { question: "Qu’est-ce que c’est, la crêpe chichi ?", answer: "C’est une fine couche de sarrasin saisie dessus dessous et parsemée de pétales de rose tiède" },
        ...
        { question: "Qu’est-ce que Bernard fait à l’arrivée au bar ?", answer: "Il fait tomber tous les skis" },
        { question: "Quel sport pratique Christiane ?", answer: "Du ski de fond" },
        { question: "Avec qui Jean-Claude Dusse prend-il des cours ?", answer: "Popeye" },
        ...
        { question: "Quel est le temps du généraliste ?", answer: "45'8" },
        ...
        { question: "Quel cadeau offre Marius avant de partir ?", answer: "Une huître en plastique qui fait pouet pouet" },
        { question: "Comment s’appelle le chien de Gigi ?", answer: "Pépette" },
        { question: "Que jette Popeye lors de l’ascension ?", answer: "Sa gourmette" },
        { question: "Comment s’appelle le plat qu’ils mangent à la ferme ?", answer: "La fougne" },
        { question: "Combien d’huîtres Christiane mange-t-elle ?", answer: "12 douzaines" },
        { question: "Qui joue Jean-Claude Dusse ?", answer: "Michel Blanc" },
        { question: "Quelle réplique célèbre de Jean-Claude Dusse concerne les Parisiens ?", answer: "Parisien, tête de chien… Parigot, tête de veau !" },
        { question: "Quelle est la réplique de Marius sur la fondue ?", answer: "Vous avez de la pâte… vous avez du sucre… alors avec la pâte, vous faites une crêpe et vous mettez du sucre dessus !" },
        { question: "Quelle est la réplique de Jean-Claude Dusse sur les généralistes ?", answer: "De toute façon, on n’a jamais vu un généraliste gagner !" },
        { question: "Quelle est la réplique de Marius sur son départ ?", answer: "Je ne m’arrête pas… je suis lancé !" },
        { question: "Quelle est la réplique de Christiane sur les huîtres ?", answer: "Combien d’huîtres Christiane mange-t-elle ? 12 douzaines !" }
    ]
